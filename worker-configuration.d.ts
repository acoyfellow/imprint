/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f1a740529e6ed2d34385756d9bfc1eb3)
// Runtime types generated with workerd@1.20260617.1 2026-04-17
interface __BaseEnv_Env {
	ADAPTERS: R2Bucket;
	AI: Ai;
	ADAPTER_RELEASES: DurableObjectNamespace<import("./src/worker").AdapterReleases>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "AdapterReleases";
	}
